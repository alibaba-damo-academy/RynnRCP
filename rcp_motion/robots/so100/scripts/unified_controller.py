...
from rcp_motion.utils.lekiwi_velocity_mapping import chassis_ikvelocity
...
class UnifiedRobotController:
    ...
    def is_external_command_timeout(self, timeout_seconds: float) -> bool:
        """Timeout logic for API/direct control path."""
    ...
    def get_state(self):
        ...
        # we should just hold/use qPos_command and let loop send it.
    ...
    def set_joint_positions(self, positions: np.ndarray) -> None:
        ...
        self.qPos_command = np.asarray(positions, dtype=float)
        self.notify_command_received()
