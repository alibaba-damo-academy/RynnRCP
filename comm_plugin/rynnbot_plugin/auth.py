...
"""
Authentication helper for the Rynnbot communication plugin.
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

This module implements :class:`~comm_plugin.rynnbot_plugin.auth.RynnAuthClient`,
    ...
    def _post_with_retry(self, url: str, what: str) -> Dict[str, Any]:
        ...
        while True:
            try:
                ...
                logger.error(f"[AUTH] Get auth {what} token failed: '{e}', retry...")
                time.sleep(1)
