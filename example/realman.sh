...
( 
    python3 -m rcp_framework.robots.realman.motion_node.realman  >> "$LOG_OUTPUT" 2>&1
) &
MOTION_PID=$!
...
( 
    ./build/rcp_framework/robots/realman/realman_servers/realman_servers \
    ./rcp_framework/robots/realman/config/device_config.yaml \
