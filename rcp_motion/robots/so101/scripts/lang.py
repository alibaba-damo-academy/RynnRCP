...
MESSAGES = {
    "en": {
        ...
        "detected_port": "\n[OK] Detected port for {dev_type}: '{port}'",
        "detected_port_env": "  DETECTED_PORT={port}",
        "updated_follower_port": "[OK] Updated {config_path} with follower port: {port}",
        "updated_leader_port": "[OK] Updated {config_path} with leader port: {port}",
        "no_port_diff": "\n[WARN] Warning: Could not detect the port for {dev_type}. No difference was found.\n",
        "too_many_ports": "\n[WARN] Warning: Could not detect the port for {dev_type}. Too many ports found ({count} ports): {ports}.\n",
        "setting_permissions": "Setting permissions for detected ports...",
        "adding_to_dialout": "Adding user {user} to dialout group...",
        "added_to_dialout": "[OK] Added {user} to dialout group",
        "dialout_next_login": "[INFO] Group membership will be active on next login, using chmod for immediate access.",
        "dialout_add_failed": "[WARN] Failed to add user to dialout group: {error}",
        "dialout_error": "[WARN] Error adding user to dialout group: {error}",
        "already_in_dialout": "[OK] User {user} is already in dialout group",
        "port_accessible": "[OK] Port {port} is already accessible",
        "setting_port_perms": "Setting permissions for {port}...",
        "perms_set": "[OK] Permissions set for {port}",
        "perms_timeout": "[WARN] Timeout setting permissions for {port}",
        "perms_failed": "[WARN] Failed to set permissions for {port}: {error}",
        "perms_hint": "[INFO] Try running the script with sudo or add your user to the dialout group manually:",
        "perms_hint_cmd": "   sudo usermod -a -G dialout $USER",
        "port_not_found": "[WARN] Port {port} not found, skipping chmod",
        "config_update_failed": "[WARN] Warning: Could not update config file: {error}",
        ...
        # find_camera_port.py
        "camera_detection": "[AIM] Camera Detection",
        "hardcoded_detection": "[SCAN] Hardcoded camera detection - using platform-specific camera assignment...",
        "found_cameras_ubuntu": "Found {count} external cameras on Ubuntu",
        "found_cameras_macos": "Found {count} cameras on macOS",
        "assigned_front": "[OK] Assigned front camera: {camera_id}",
        "assigned_wrist": "[OK] Assigned wrist camera: {camera_id}",
        "not_enough_cameras": "[WARN] Only found {count} cameras, need at least 2",
        "updated_front_camera": "[OK] Updated front camera port: {camera_id}",
        "updated_wrist_camera": "[OK] Updated wrist camera port: {camera_id}",
        "camera_config_saved": "[SAVE] Camera configuration saved to {config_path}",
        "camera_config_failed": "[ERR] Warning: Could not update camera config file: {error}",
        "manual_set_cameras": "  Please manually set camera ports in {config_path}",
        "camera_detection_done": "[OK] Camera detection completed using hardcoded assignment",
        "detected_cameras": "\n--- Detected Cameras ---",
    ...
    "zh": {
        ...
        "detected_port": "\n[OK] 检测到 {dev_type} 的端口：'{port}'",
        "detected_port_env": "  DETECTED_PORT={port}",
        "updated_follower_port": "[OK] 已更新 {config_path} 从臂端口：{port}",
        "updated_leader_port": "[OK] 已更新 {config_path} 主臂端口：{port}",
        "no_port_diff": "\n[WARN] 警告：无法检测 {dev_type} 的端口，未发现差异。\n",
        "too_many_ports": "\n[WARN] 警告：无法检测 {dev_type} 的端口，发现过多端口（{count}个）：{ports}。\n",
        "setting_permissions": "正在设置检测到的端口权限...",
        "adding_to_dialout": "正在将用户 {user} 添加到 dialout 组...",
        "added_to_dialout": "[OK] 已将 {user} 添加到 dialout 组",
        "dialout_next_login": "[INFO] 组成员资格将在下次登录后生效，现使用 chmod 进行临时访问。",
        "dialout_add_failed": "[WARN] 添加用户到 dialout 组失败：{error}",
        "dialout_error": "[WARN] 添加用户到 dialout 组时出错：{error}",
        "already_in_dialout": "[OK] 用户 {user} 已在 dialout 组中",
        "port_accessible": "[OK] 端口 {port} 已可访问",
        "setting_port_perms": "正在设置 {port} 的权限...",
        "perms_set": "[OK] 已设置 {port} 的权限",
        "perms_timeout": "[WARN] 设置 {port} 权限超时",
        "perms_failed": "[WARN] 设置 {port} 权限失败：{error}",
        "perms_hint": "[INFO] 请尝试使用 sudo 运行脚本，或手动将用户添加到 dialout 组：",
        "perms_hint_cmd": "   sudo usermod -a -G dialout $USER",
        "port_not_found": "[WARN] 未找到端口 {port}，跳过 chmod",
        "config_update_failed": "[WARN] 警告：无法更新配置文件：{error}",
        ...
        # find_camera_port.py
        "camera_detection": "[AIM] 摄像头检测",
        "hardcoded_detection": "[SCAN] 硬编码摄像头检测 - 使用平台特定的摄像头分配...",
        "found_cameras_ubuntu": "在 Ubuntu 上找到 {count} 个外部摄像头",
        "found_cameras_macos": "在 macOS 上找到 {count} 个摄像头",
        "assigned_front": "[OK] 已分配前置摄像头：{camera_id}",
        "assigned_wrist": "[OK] 已分配腕部摄像头：{camera_id}",
        "not_enough_cameras": "[WARN] 仅找到 {count} 个摄像头，至少需要2个",
        "updated_front_camera": "[OK] 已更新前置摄像头端口：{camera_id}",
        "updated_wrist_camera": "[OK] 已更新腕部摄像头端口：{camera_id}",
        "camera_config_saved": "[SAVE] 摄像头配置已保存到 {config_path}",
        "camera_config_failed": "[ERR] 警告：无法更新摄像头配置文件：{error}",
        "manual_set_cameras": "  请手动在 {config_path} 中设置摄像头端口",
        "camera_detection_done": "[OK] 使用硬编码分配完成摄像头检测",
        "detected_cameras": "\n--- 检测到的摄像头 ---",
        "camera_num": "摄像头 #{num}:",
