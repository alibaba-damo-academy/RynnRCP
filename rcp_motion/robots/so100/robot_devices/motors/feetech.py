...
from robot_devices.utils import (
...
class FeetechMotorsBus:
    ...
    ```bash
    python lerobot/scripts/find_write_port.py
    ...
    def connect(self):
        ...
        try:
            ...
            traceback.print_exc()
            print(
                "\nTry running `python lerobot/scripts/find_write_port.py` to make sure you are using the correct port.\n"
            )
            raise
